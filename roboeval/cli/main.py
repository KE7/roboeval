...
def cmd_run(
    ...
    shard_id: int | None = typer.Option(
        None,
        "--shard-id",
...
def cmd_serve(
    ...
    from roboeval.server_runner import install_signal_handlers, start_sim, start_vla, wait_for_exit
